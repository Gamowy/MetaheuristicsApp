...
namespace MetaheuristicsAPI.FitnessFunctions.TSFDE
{
    class TSFDE_fractional_boundary
    {
        ...
        public double[][] fitnessFunctionDomain()
        {
            double[][] domain = new double[7][];;
            ...
            domain[2][0] = 1.0;
            domain[2][1] = 5.0;
            domain[3] = new double[2];
            domain[3][0] = -70;
            domain[3][1] = -20;
            domain[4] = new double[2];
            domain[4][0] = 250;
            domain[4][1] = 450;
            domain[5] = new double[5];
            domain[5][0] = -30;
            domain[5][1] = -10;
            domain[6] = new double[6];
            domain[6][0] = 50;
            domain[6][1] = 250;
            return domain;
        }
